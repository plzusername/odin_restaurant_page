...
function menuPage(){
    ...
    return elemCreator( '', content , ...[
        ...
        , new menuItem('Chicken shawerma Assaj','Arabic flat bread, 2lb Chicken (Assaj), A hot Red Pepper, Spicey red Pepper Sauce, Well cooked Onions, and of course the special ingrediant: Sincerity!','2.50 JD').callConvertMenutoDom()
        ...
        , new menuItem('Kebab shawerma','Arabic Hamam bread, 3lb Meat Kebab , Extreme amounts of ketchup, Grated cucumbers, Chopped onions and tomatoes, and of course the special ingrediant: Excellency!','3.00 JD').callConvertMenutoDom()
