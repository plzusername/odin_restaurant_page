...
function homePage(){
    ...
    description = elemCreator( 'p', homeSection , `Has Shawerma ever had a lasting impact on you, well then you're in the right plac! Mini Uncle Shawerma(MUS) has had a profound impact on the happiness of kids since 1901, so what are you wating for!` , {'class':['restaurant-description']} )
